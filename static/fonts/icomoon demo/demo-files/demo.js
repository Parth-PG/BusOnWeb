...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "atQjXHYCQEd442ApID1lqUejzoHAyvOU5KiPmA7yXseovk2GBjaJvMJ3riNnIFNj";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='atQjXHYCQEd442ApID1lqUejzoHAyvOU5KiPmA7yXseovk2GBjaJvMJ3riNnIFNj' />
    <table>

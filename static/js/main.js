...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "A7bYhvBJWVBJg1r2K9w7mjAfPtINztoemTsCeS6bIvjp39WgcqWSSIbfrIKZXDsc";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='A7bYhvBJWVBJg1r2K9w7mjAfPtINztoemTsCeS6bIvjp39WgcqWSSIbfrIKZXDsc' />
    <table>

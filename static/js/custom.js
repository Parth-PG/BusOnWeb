...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "qKR2DlBGPyQlnJLX2D5HHa37uqH1MxOdiwlnvBHALvdMoENw3eetlvlHsYXTB7n9";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='qKR2DlBGPyQlnJLX2D5HHa37uqH1MxOdiwlnvBHALvdMoENw3eetlvlHsYXTB7n9' />
    <table>

...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "7pmoyKQQdEhpHfJIbFLLl9yoEaJ05ACZbZzvRTlyuUF9Nqh04V5qMIewgP5dIxB8";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='7pmoyKQQdEhpHfJIbFLLl9yoEaJ05ACZbZzvRTlyuUF9Nqh04V5qMIewgP5dIxB8' />
    <table>
